...
(function() {
  var Interviewer, accessToken, allSlots, assert, assertEqual, authorizationUrl, busyFreeToInterviewers, busyTime, countAvailableSlots, email, exampleBusyFree, exampleJSONresponseToBusyFree, freeSlots, freeTime, getBusyFree, getEmailAddresses, givenDay, googleClientId, i, interviewer, interviewers, isTokenValid, knownEmailAddresses, knownFreeSlots, nextDay, params, parseParams, permutationsExhausted, permuteUntilSlotsWork, redirectUri, slot, slotsThatWork, someStuff, _i, _j, _len, _len1;
  ...
  someStuff = function() {
    var comingWeek, day, i, interviewers, today, workingSlots, _j, _k, _len1, _results;
    comingWeek = [];
    today = new Date();
    ...
    for (_k = 0, _len1 = comingWeek.length; _k < _len1; _k++) {
      day = comingWeek[_k];
      _results.push(workingSlots = permuteUntilSlotsWork(day, interviewers));
    }
    return _results;
  };
  ...
  assert([] === interviewer.freeSlotsOn(givenDay));
