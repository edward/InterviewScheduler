...
(function() {
  ...
  $("#go").click(function() {
    ...
    return getBusyFree(accessToken, emailAddresses, function(busyFree) {
      ...
      return console.log(schedulesPossibleInNextWeek(interviewers));
    });
  });
